  ...
  public class Database : Component
  {
    ...
    public void RegisterCronJobs()
    {
      ...
      List<CronJob> cronJobDefinitions = new List<CronJob>()
      {
        ...
        // Checks if any of the activities expired and if so, it deletes them.
        { new CronJob() { Name = "checkExpiredActivities", StartDelay = 59 * 1000, Interval = 119 * 60 * 1000, HandlerAsync = CronJobHandlerCheckExpiredActivitiesAsync } },
    ...
    /// <summary>
    /// Handler for "checkExpiredActivities" cron job.
    /// </summary>
    public async void CronJobHandlerCheckExpiredActivitiesAsync()
    {
      log.Trace("()");
